...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception {
        ...
        Date date = DATE_FORMAT.parse("2018-08-08");
        ...
        given(reservationService.getRoomReservationsForDate("2018-08-08")).willReturn(mockReservationList);
        this.mockMvc.perform(get("/reservations?date=2018-08-08")).andExpect(status().isOk()).andExpect(content().string(containsString("Test, JUnit")));
